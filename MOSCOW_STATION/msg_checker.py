...
MOSRENTGEN_1=(55.6191241, 37.4662008, 50);
# MOSRENTGEN_2=();
# noise_station_coordinates=[MOSRENTGEN_1, MOSRENTGEN_2];

noise_station_coordinates=[MOSRENTGEN_1];
...
def main():
	txt_list=sorted(glob.glob('VNK_SBS.2*'), key = lambda file: os.path.getctime(file)) # find all txt in the folders
