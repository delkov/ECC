...
path="/home/delkov/Documents/air/WORKING_STATION/SERVER/"
os.chdir(path)
...
def main():
	...
	# try:
	noise_query=[]
	file_list=sorted(glob.glob('2018*.txt')) # by default sort by name;	key = lambda file: os.path.getctime(file)) # find all txt in the folders
	# try:
	we_have_data=False
